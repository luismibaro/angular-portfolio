...
export class ProjectsService {
  ...
  projects: Project[] = [
    {id: 0, name: "Angular Jukebox", pictures: ["../../assets/jukebox/jukebox-front.jpeg","../../assets/jukebox/jukebox0.png"], projectLink: "//www.github.com", summary: "Project that displays the pending songs on a jukebox.", description: "This project represents my initial foray into Angular framework development. As I continue to iterate on it, I aim to delve deeper into Angular's functionalities and best practices. Your feedback and suggestions are highly appreciated as they contribute to both the improvement of this project and my learning journey.", tags: [Tag.TYPESCRIPT, Tag.ANGULAR]},
    /*
